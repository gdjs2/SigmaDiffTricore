...
public class GraphConstructor extends GhidraScript {
    ...
    protected void run() throws Exception {
        ...
        writer = new BufferedWriter(new FileWriter("/Users/gdjs2/Desktop/sigmadiff/script/GraphConstructor/graph.txt"));
