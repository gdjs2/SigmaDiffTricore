...
def processDGMC(dir, filename1, filename2, args):
    ...
    corpus.get_data(node_label_file_1,edge_file_1,node_label_file_2,edge_file_2,training_file,func_matching_file,subject_dir,pretrained_subject, with_gt)
...
if __name__ == "__main__":
    processDGMC("/mnt/sata/zhaoqi/tricore/sigmadiff_result_withimgbase", "firmware_image1.bin", "firmware_image2.bin", None)